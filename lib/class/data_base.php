...
class DB
{
    public static $dsn = 'mysql:dbname=irgrp;host=openserver';//localhost';
    public static $user = 'deposit_admin';
    public static $pass = 'p555777q';
        ...
        if (!self::$dbh) {
            try {
                self::$dbh = new PDO(
                    ...
                    self::$user, 
                    self::$pass, 
                    array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8')//, 'SET GLOBAL time_zone = "+02:00"'
                );
